...
module.exports = {
  ...
  formatTime: require('./src/formatTime/formatTime'),
  estimateInHours: require('./src/estimateInHours/estimateInHours'),
  calculateAverageRating:
    require('./src/calculateAverageRating/calculateAverageRating'),
  calculateRoundedRating:
    require('./src/calculateRoundedRating/calculateRoundedRating'),
  calculateWidth: require('./src/calculateWidth/calculateWidth'),
  generateRandomNumber:
    require('./src/generateRandomNumber/generateRandomNumber'),
